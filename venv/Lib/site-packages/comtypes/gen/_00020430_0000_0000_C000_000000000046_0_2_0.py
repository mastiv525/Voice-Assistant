...
__all__ = [ 'FONTSTRIKETHROUGH', 'Gray', 'FONTUNDERSCORE',
           'OLE_XPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'FONTSIZE',
           'StdPicture', 'IPicture', 'OLE_OPTEXCLUSIVE',
           'OLE_YPOS_PIXELS', 'IPictureDisp', 'FONTITALIC',
           'LoadPictureConstants', 'OLE_YSIZE_HIMETRIC', 'Picture',
           'OLE_HANDLE', 'OLE_CANCELBOOL', 'OLE_XPOS_HIMETRIC',
           'OLE_TRISTATE', 'IFontDisp', 'Monochrome', 'VgaColor',
           'OLE_XSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'Default',
           'IFont', 'OLE_YPOS_CONTAINER', 'OLE_YSIZE_CONTAINER',
           'Font', 'OLE_XPOS_PIXELS', 'FontEvents',
           'OLE_YPOS_HIMETRIC', 'Color', 'OLE_COLOR', 'StdFont',
           'Checked', 'Unchecked', 'FONTNAME', 'FONTBOLD',
